...
Game.prototype.finishGame = function (toBeWinner) {
    ...
    else if (this.winner === 'Spy and Puck') {
        this.sendText(this.allSockets, 'The spies and Puck win!', 'gameplay-text-red');
    } else if (this.winner === 'Resistance') {
        this.sendText(this.allSockets, 'The resistance wins!', 'gameplay-text-blue');	
    } else if (this.winner === 'Resistance and Puck') {
        this.sendText(this.allSockets, 'The resistance and Puck wins!', 'gameplay-text-blue');
    }
