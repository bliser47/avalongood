class MordredAssassin {
    constructor(thisRoom) {
        this.thisRoom = thisRoom;

        this.specialPhase = 'assassination';

        this.role = 'Mordred Assassin';
        this.alliance = 'Spy';

        this.description = 'If the resistance win 3 missions, Mordred Assassin can shoot one person for Merlin or Guinevere, or two people for Tristan and Isolde. If they are correct, the spies win!';
            ...
            if (this.thisRoom.phase === 'finished') {
                ...
                for (var i = 0; i < this.thisRoom.playersInGame.length; i++) {
                    ...
                    if (this.thisRoom.playersInGame[i].role === 'Guinevere') {
                        guinevereExists = true;
                    }
                }

                if (numOfSuccesses === 3 && ((merlinExists === true) || (tristExists === true && isoExists === true) || (guinevereExists === true))) {
...
module.exports = MordredAssassin;
