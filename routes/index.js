...
const processRecords = async function (records) {
    ...
    const resRoles = ['Merlin', 'Percival', 'Resistance', 'Isolde', 'Tristan', 'Guinevere', 'Good Lancelot'];
    const spyRoles = ['Assassin', 'Morgana', 'Spy', 'Mordred', 'Oberon', 'Mordred Assassin', 'Bad Lancelot', 'Mark', 'Puck'];
